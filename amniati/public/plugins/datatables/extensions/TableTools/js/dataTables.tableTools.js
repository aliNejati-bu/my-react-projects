...
TableTools.prototype = {
	...
	/**
	 * Programmatically enable or disable the print views
	 *  @param {boolean} [bView=true] Show the print views if true or not given. If false, then
	 *    terminate the print views and return to normal.
	 *  @param {object} [oConfig={}] Configuration for the print views
	 *  @param {boolean} [oConfig.bShowAll=false] Show all rows in the table if true
	 *  @param {string} [oConfig.sInfo] Information message, displayed as an overlay to the
	 *    user to let them know what the print views is.
